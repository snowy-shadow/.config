...
local highlights = {
  ...
  IncSearch = { fg = c.green, bold = true },
  Search = { fg = c.green, bold = true, underline = false },
  Directory = { fg = c.cyan },
  Folded = { fg = c.grey3 },
  WildMenu = { fg = c.cyan },
  ...
  -- LSP
  LspReferenceText = { fg = c.background, bold = true, underline = false },
  LspReferenceRead = { fg = c.background, bold = true, underline = false },
  LspReferenceWrite = { fg = c.background, bold = true, underline = false },
  DiagnosticTruncateLine = { fg = c.hidden },
  DiagnosticError = { fg = c.error },
  DiagnosticWarn = { fg = c.warning },
  DiagnosticInfo = { fg = c.info },
  DiagnosticHint = { fg = c.info },
  LspCodeLens = { fg = c.type_name, italic = false },
  IndentBlanklineChar = { fg = c.grey2 },
  IndentBlanklineContextChar = { fg = c.key },

  -- LSP Signature
  LspSelectedParam = { fg = c.normal, bold = true, underline = false },
  ...
  CmpItemAbbrMatchFuzzy = { fg = c.normal, bold = true, underline = false },
